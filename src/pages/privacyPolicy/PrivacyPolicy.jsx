...
const PrivacyPolicy = () => {
  return (
    <div className="privacy">
      <Container>
        <h1>Privacy Policy for Film Garage</h1>

        <p>
          At Film Garage, accessible from filmgaragebd.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Film Garage and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Film Garage. This policy is not applicable to
        ...
        <p>
          Film Garage follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertising partners of Film Garage.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Film Garage, which are sent
        ...
        <p>
          Note that Film Garage has no access to or control over these cookies
        ...
        <p>
          Film Garage's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          <span>The rightto object to processing - </span>You have the right to
        ...
        <p>
          Film Garage does not knowingly collect any Personal Identifiable
