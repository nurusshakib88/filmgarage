  ...
  return (
    <div className="refund">
      <Container>
        ...
        <p>Thank you for shopping at Film Garage.</p>
        <p>
        ...
        <ul>
          <li>
            <p>
              ...
              in this Agreement) refers to Film Garage, 385/6, Free School
              Street, Hatirpool Dhaka, Bangladesh.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Film Garage, accessible from{" "}
              <NavLink to="/">filmgaragebd.com</NavLink>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            <p>By email: contact@filmgaragebd.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <NavLink to="/contact">www.filmgaragebd.com/contact</NavLink>
            </p>
          </li>
        </ul>
        <p>
